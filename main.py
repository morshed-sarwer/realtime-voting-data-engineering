...
import psycopg2
from config.settings import DATABASE_PARAMS, KAFKA_BROKER
...
if __name__ == "__main__":
    ...
    for i in range(1000):
        ...
        # to see kafka data Exec command-> kafka-console-consumer --topic voter_topics --bootstrap-server broker:29092
